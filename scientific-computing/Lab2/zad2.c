...
const char* FILE_NAME = "zad2_results.txt";
...
int main() {
  ...
  // BLAS 1
  b1 = (result**) calloc(AMOUNT_OF*AMOUNT_PER_N, sizeof(result*));
  blas1(b1);

  for(i=0; i<AMOUNT_OF*AMOUNT_PER_N; i++) {
  ...
  // BLAS 2
  b2 = (result**) calloc(AMOUNT_OF*AMOUNT_PER_N, sizeof(result*));
  blas2(b2);
